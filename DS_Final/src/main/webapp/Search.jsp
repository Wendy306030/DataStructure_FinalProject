...
.note{
    ...
    margin-left: -100px; /* 將 margin-left 設為元素寬度的一半，使其水平置中 */
...
<body style='background-color:#DBD0C2'>
<form action='${requestUri}' method='get'>

<div class = 'box'style = 'position:absolute;margin-top:530px;margin-left:635px;'></div>
<div class='note'>
<img src="images/3dglass.png" style = 'position:absolute;width:40px;height:40px;margin-top:520px' >
</div> 
<div class='note1'>
<img src="images/popcorn.png" style = 'position:absolute;width:40px;height:40px;margin-top:520px' >
</div> 
<div class='note2'>
<img src="images/camera-2.png" style = 'position:absolute;width:40px;height:40px;margin-top:520px' >
</div>
<div class='note3'>
<img src="images/camera.png" style = 'position:absolute;width:40px;height:40px;margin-top:520px' >
</div>  
<div>
...
<div>
<input type='text' name='searchNum' value='10' style='color:#DBD0C2;border-style:none;background-color:#DBD0C2'>
</div>
<div>
...
<div>
<a href ='http://localhost:8080/Final_Project/TestProject' style="display: flex; justify-content: center; align-items: flex-start; height: 100vh;">
    <img src="images/movie-2.PNG" style="width: 600px; height: 200px;">
</a>
</div>
</form>
</body>
